                ...
                <div className="space-y-4">
                    {combinedProducts.length > 0
                        ? combinedProducts.map((product, index) => (
                              <div
                                  key={product.id}
                                  className="flex items-center space-x-4 p-1 hover:bg-gray-50 rounded-lg transition-colors"
                              >
                                  <div
                                      className={`w-12 h-12 rounded-lg ${product.bgColor} flex items-center justify-center flex-shrink-0`}
                                  >
